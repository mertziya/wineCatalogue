...
class RedWineVC: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        setBindings()
        wineVM.loadWines(type: .reds) // loads data and initializes the first ten object to observedWines.
...
extension RedWineVC : UITableViewDelegate , UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "RedWineVCtoWineDetailsVC", sender: nil)
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "RedWineVCtoWineDetailsVC"{
